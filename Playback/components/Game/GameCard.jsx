...
import { Card, Image, View, Text, XStack, H2, H4, H5 } from 'tamagui';
	...
	>
		...
		>
			<Card.Header padded borderRadius={SIZES.medium}>
				<H5 opacity={0.9} margin='$2' width='100%' textAlign='center' fontWeight={'bold'} alignSelf='center' maxWidth={250} wordWrap='break-word' padding={SIZES.xSmall} backgroundColor={COLORS.lightWhite}>{item.name}</H5>
			</Card.Header>
